...
This repository contains my projects and exercises completed as part of "iOS & Swift - The Complete iOS App Development Bootcamp" by Angela Yu on Udemy.
...
* Software Design: How to organise and format code for readability and how to implement the Model ­View­ Controller (MVC) design pattern, Apple's favourite delegation pattern 
...
1.  Clone this repository to your local machine:
    ```bash
    git clone https://github.com/kajbr88/iOS-Swift-The-Complete-iOS-App-Development-Bootcamp.git
    ```
2.  Open the project in Xcode.
3.  If the project uses CocoaPods, navigate to the project directory in your terminal and run:
    ```bash
    pod install
    ```
